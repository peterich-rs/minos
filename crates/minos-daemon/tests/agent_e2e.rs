...
//!
//! Phase F.6 rebuilds this test on top of the in-process backend fixture
...
#[tokio::test]
#[ignore = "Phase F rewrite pending: agent-runtime e2e needs backend-backed rewrite in F.6"]
