...
extension MinosErrorDisplay on MinosError {
  ...
  ErrorKind get kind => switch (this) {
    ...
    MinosError_GeminiSpawnFailed() => ErrorKind.geminiSpawnFailed,
    MinosError_AcpProtocolError() => ErrorKind.acpProtocolError,
    ...
    MinosError_SessionNotFound() => ErrorKind.sessionNotFound,
  ...
  String? get detail => switch (this) {
    ...
    final MinosError_GeminiSpawnFailed e => e.message,
    final MinosError_AcpProtocolError e => '${e.method}: ${e.message}',
    ...
    final MinosError_IngestSeqConflict e => '${e.sessionId}@${e.seq}',
    final MinosError_SessionNotFound e => e.sessionId,
