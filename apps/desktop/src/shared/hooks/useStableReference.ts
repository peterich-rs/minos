 ...
 * is recomputed into a fresh Map on an unrelated invalidation keep a stable
 * identity so downstream `React.memo` boundaries can bail.
 */
 ...
 * `useStableMap` for array-valued derived state.
 */
